...
In this code pattern, you will create a Backend for Frontend (BFF) web service using [Spring](https://spring.io/) in Java, matching a RESTful API documented in [Swagger](https://swagger.io/).
